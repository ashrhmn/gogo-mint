import { getContractUri } from "../constants/tokenUri";
import { normalizeString } from "../utils/String.utils";

export const get721ContractCode = (contractName: string) => {
  return `
  ...
  // File contracts/Collection721.sol
  
  pragma solidity ^0.8.0;
  
  contract ${normalizeString(contractName)} is Ownable, ERC721URIStorage {
